...
export const inngest = new Inngest({ id: "WorkSphere-WMP" });
    ...
    if(!attendance?.checkOut){
        ...
        await sendEmail({
          ...
          body: `<div style="max-width: 600px;">
                    ...
                    <p style="font-size: 16px;">WorkSphere</p>
                </div>`
        })
...
// Send Email to admin, If admin doesn't take action or leave application within 24 hours
...
const attendaceReminderCron = inngest.createFunction(
  {
  ...
  async ({ step }) => {
        ...
        // step 5: filter absent employees (not on leaves and not checked in)
