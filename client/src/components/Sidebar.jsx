...
import { href, Link, useAsyncError, useLocation } from 'react-router-dom'
import { dummyProfileData } from '../assets/assets'
import { CalendarIcon, ChevronRightIcon, DollarSignIcon, FileTextIcon, Icon, LayoutGrid, LayoutGridIcon, Loader2, LogOutIcon, MenuIcon, SettingsIcon, UserIcon, XIcon } from 'lucide-react'
            ...
            <div className='px-5 pt-6 pb-5 border-b border-white/6'>
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            <p className='font-semibold text-[13px] text-white tracking-wide'>WorkSphere</p>
                            <p className='text-[11px] text-slate-500    font-medium'>Management Platform</p>
                        </div>
                    </div>
