...
const LoginLanding = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-16 relative overflow-y-auto min-h-screen">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-slate-500">Choose your portal to access your workspace.</p>
          </div>
