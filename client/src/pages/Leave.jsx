...
const Leave = () => {
  ...
  const fetLeaves = useCallback(async() => {
    try {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <LeaveHistory leaves={leaves} isAdmin={isAdmin} onUpdate={fetLeaves} />
      <ApplyLeaveModal open={showModal} onClose={() => setShowModal(false)} onSuccess={fetLeaves}/>
    </div>
  )
}
